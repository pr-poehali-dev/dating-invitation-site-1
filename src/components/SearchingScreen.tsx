...
export const SEARCH_STEPS = [
  { from: 0, to: 10, label: "Ищу...", duration: 5400 },
  { from: 10, to: 25, label: "Убираю Фобо из списка", duration: 5100 },
  {
    from: 25,
    to: 40,
  ...
  { from: 40, to: 65, label: "Выбираю что-то поинтереснее", duration: 5100 },
  { from: 65, to: 75, label: "Почти нашёл....", duration: 5100 },
  {
    from: 75,
    to: 88,
  ...
  { from: 88, to: 95, label: "Ещё чуть-чуть", duration: 5100 },
  { from: 95, to: 100, label: "Готово", duration: 5100 },
];
